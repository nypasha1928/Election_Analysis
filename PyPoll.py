...
with open(file_to_load) as election_data:
   ...
   for row in file_reader:
      ...
      # If the the candidate does not match any existing candidate...
...
for candidate_name in candidate_votes:
   ...
   # To do: print out each candidates's name, vote count, and the percentage of votes to the terminal.
